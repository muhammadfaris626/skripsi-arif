<script setup>
    ...
    const tambahData = () => {
        form.post(route('businessCertificates.store'), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
            }
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <Link :href="route('businessCertificates.index')" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Surat Keterangan Usaha</Link>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah Surat Keterangan Usaha</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="pt-4">
                <h1 class="text-2xl font-semibold text-blue-600">TAMBAH SURAT KETERANGAN USAHA</h1>
                <form @submit.prevent="tambahData">
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            <InputLabel for="business_address">
                        ...
                        <div>
                            ...
                            />
                            <InputError :message="form.errors.long_term" />
                        </div>
                        <div>
                            <InputLabel for="description">
                                Alasan Keperluan Berkas <span class="text-red-500">*</span>
                            </InputLabel>
                            <TextInput
                                id="description"
                                type="text"
                    ...
                    <div class="mt-6">
                        ...
                        <Link :href="route('businessCertificates.index')" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">KEMBALI</Link>
                    </div>
                </form>
            </div>
        </div>
