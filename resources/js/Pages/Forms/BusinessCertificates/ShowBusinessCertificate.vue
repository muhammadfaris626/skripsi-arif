    ...
    <div class="grid grid-cols-1 gap-4 p-4">
        ...
        <div class="border-t-8 mx-24 border-black">
            <div class="border-t-2 mt-1 border-black">
                <p class="text-center underline font-bold text-xl mt-5">SURAT KETERANGAN USAHA</p>
                ...
                <div class="grid grid-cols-3">
                    <div class="ml-20 col-span-2 relative">
                        <table class="text-md text-left rtl:text-right whitespace-nowrap">
                            <tbody>
                                <tr>
                                    <td scope="row" class="px-6">
                                        Nama
                        ...
                        <p class="px-6 text-md">Yang tersebut namanya di atas, memiliki usaha :</p>
                        <table class="text-md text-left rtl:text-right whitespace-nowrap">
                            <tbody>
                                <tr>
                                    <td scope="row" class="px-6">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6">
                                        <!-- : {{ props.fetchData.resident[0].resident_number }} -->
                                        : {{ props.fetchData.business_address }}
                                    </td>
                                </tr>
                                <tr>
                                    <td scope="row" class="px-6 ">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6">
                                        : {{ new Date(props.fetchData.validity_period).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' }) }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <p class="mx-10 text-lg text-justify">
                    Demikian surat keterangan ini dibuat dengan sesungguhnya sesuai surat pengantar Nomor <b>{{ props.fetchData.request_number }}</b> Tanggal
                    {{ new Date().toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' }) }}, dan dipergunakan <b>{{ props.fetchData.description }}</b>.
                </p>
