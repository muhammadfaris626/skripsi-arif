<script setup>
    ...
    let searchUrl = computed(() => {
        let url = new URL(route('businessCertificates.index'));
    ...
    const modalLiatData = (data) => {
        ...
        form.resident_id = data.resident_id;
        form.name = data.name;
    ...
    const ubahData = () => {
        form.put(route('businessCertificates.update', form.id), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
    ...
    const hapusData = () => {
        form.delete(route('businessCertificates.destroy', form.id), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
                showModalDelete.value = false;
    ...
    const cetak = () => {
        form.get(route('businessCertificates.show', form.id), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
                showModalRead.value = false;
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Surat Keterangan Usaha</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex justify-between my-3">
                ...
                <div>
                    <template v-if="hasPermission('business-certificate: create')">
                        <Link :href="route('businessCertificates.create')" class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <template #default>
                    <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <TableDataCell :status="'action'">
                            <!-- Lihat Data  -->
                            <template v-if="hasPermission('business-certificate: read')">
                            ...
                            <!-- Ubah Data  -->
                            <template v-if="hasPermission('business-certificate: update')">
                            ...
                            <!-- Hapus Data  -->
                            <template v-if="hasPermission('business-certificate: delete')">
                ...
                <div class="relative w-full max-w-3xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            Apakah anda yakin ingin menghapus surat keterangan usaha ini ?
                        </h3>
