<script setup>
    ...
    const tambahData = () => {
        form.post(route('inability-certificates.store'), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
            }
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <Link :href="route('inability-certificates.index')" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Surat Keterangan Tidak Mampu</Link>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah Surat Keterangan Tidak Mampu</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="pt-4">
                <h1 class="text-2xl font-semibold text-blue-600">TAMBAH SURAT KETERANGAN TIDAK MAMPU</h1>
                <form action=""></form>
                <form @submit.prevent="tambahData">
                    ...
                    <div class="mt-6">
                        ...
                        <Link :href="route('inability-certificates.index')" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">KEMBALI</Link>
                    </div>
                </form>
            </div>
        </div>
