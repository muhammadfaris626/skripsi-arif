    ...
    <div class="grid grid-cols-1 gap-4 p-4">
        ...
        <div class="border-t-8 mx-24 border-black">
            <div class="border-t-2 mt-1 border-black">
                <p class="text-center underline font-bold text-xl mt-5">SURAT KETERANGAN TIDAK MAMPU</p>
                ...
                <p class="mx-10 text-lg text-justify">
                    Yang tersebut namanya di atas adalah penduduk Kelurahan Katimbang Kecamatan Biringkanaya Kota Makassar
                    dan berdomisili pada alamat tersebut di atas sesuai pengantar Nomor <b>{{ props.fetchData.request_number }}</b>
                    Tanggal {{ new Date().toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' }) }},
                    warga tersebut termasuk <b>Keluarga Tidak Mampu</b>.
                </p>
