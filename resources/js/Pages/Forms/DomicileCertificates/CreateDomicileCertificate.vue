<script setup>
    ...
    const tambahData = () => {
        form.post(route('domicile-certificates.store'), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
            }
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <Link :href="route('domicile-certificates.index')" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Surat Keterangan Domisili</Link>
                            </div>
                        </li>
            ...
            <div class="pt-4">
                <h1 class="text-2xl font-semibold text-blue-600">TAMBAH SURAT KETERANGAN DOMISILI</h1>
                <form @submit.prevent="tambahData">
                    ...
                    <div class="mt-6">
                        ...
                        <Link :href="route('domicile-certificates.index')" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">KEMBALI</Link>
                    </div>
                </form>
            </div>
        </div>
