<script setup>
    ...
    const modalLiatData = (data) => {
        ...
        form.couple_name = data.couple_name;
        form.partner_address = data.partner_address;
        form.guardian_name = data.guardian_name;
        form.wedding_date = data.wedding_date;
        form.name_of_the_chief = data.name_of_the_chief;
        form.bride_price = data.bride_price;
        form.witness_name = data.witness_name;
    ...
    const ubahData = () => {
        form.put(route('marriage-certificates.update', form.id), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
    ...
    const hapusData = () => {
        form.delete(route('marriage-certificates.destroy', form.id), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
                showModalDelete.value = false;
    ...
    const cetak = () => {
        form.get(route('marriage-certificates.show', form.id), {
            onSuccess: () => {
                form.reset();
                form.clearErrors();
                showModalRead.value = false;
    ...
    <AuthenticatedLayout>
        <div class="grid grid-cols-1 h-full">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Surat Keterangan Menikah</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex justify-between my-3">
                ...
                <div>
                    <template v-if="hasPermission('marriage-certificate: create')">
                        <Link :href="route('marriage-certificates.create')" class="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <template #default>
                    <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <TableDataCell :status="'action'">
                            <!-- Lihat Data  -->
                            <template v-if="hasPermission('marriage-certificate: read')">
                            ...
                            <!-- Ubah Data  -->
                            <template v-if="hasPermission('marriage-certificate: update')">
                            ...
                            <!-- Hapus Data  -->
                            <template v-if="hasPermission('marriage-certificate: delete')">
                ...
                <div class="relative w-full max-w-3xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                            LIHAT SURAT KETERANGAN MENIKAH
                        </h3>
                ...
                <div class="relative w-full max-w-3xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            Apakah anda yakin ingin menghapus surat keterangan menikah ini ?
                        </h3>
