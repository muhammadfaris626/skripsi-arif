<script setup>
    ...
    const modalLiatData = (data) => {
        ...
        form.id = data.id;
        form.cover_letter_id = data.certificate_id.cover_letter_id[0].request_number;
        form.request_number = data.certificate_id.request_number;
        form.user_id = data.certificate_id.user_id[0].name;
        form.resident_id = data.certificate_id.resident_id;
        form.name = data.certificate_id.name;
        form.resident_number = data.certificate_id.resident_number;
        form.place_of_birth = data.certificate_id.place_of_birth;
        form.date_of_birth = data.certificate_id.date_of_birth;
        form.religion = data.certificate_id.religion;
        form.gender = data.certificate_id.gender;
        form.work_id = data.certificate_id.work_id[0].work_name;
        form.address = data.certificate_id.address;
        form.business_name = data.certificate_id.business_name;
        form.business_address = data.certificate_id.business_address;
        form.long_term = data.certificate_id.long_term;
        form.validity_period = data.certificate_id.validity_period;
        form.description = data.certificate_id.description;
        form.created_at = data.certificate_id.created_at;
        form.updated_at = data.certificate_id.updated_at;
        form.history = data.certificate_id.history;
    }
    ...
    const modalUbahData = (data) => {
        ...
        form.id = data.id;
        form.approvalCategory = data.certificate_id.cover_letter_id[0].certificate_category_id[0].certificate_category_name;
    }
    const ubahData = () => {
            ...
            <Table>
                ...
                <template #default>
                    <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <TableDataCell :status="'record'">{{ data.certificate_id.cover_letter_id[0].certificate_category_id[0].certificate_category_name }}</TableDataCell>
                        <TableDataCell :status="'record'">{{ data.certificate_id.request_number }}</TableDataCell>
                        <TableDataCell :status="'record'">{{ data.certificate_id.cover_letter_id[0].request_number }}</TableDataCell>
                        <TableDataCell :status="'record'">{{ data.certificate_id.user_id[0].name }}</TableDataCell>
                        <TableDataCell :status="'record'">{{ data.certificate_id.created_at }}</TableDataCell>
