<script setup>
    ...
    const modalLiatData = (data) => {
        ...
        form.marital_status = data.certificate_id.marital_status;
            ...
            <Table>
                <template #header>
                    <TableRow>
                        ...
                        <TableHeaderCell class="whitespace-nowrap">NOMOR SURAT PENGANTAR</TableHeaderCell>
                ...
                <template #default>
                    <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <TableDataCell :status="'record'" class="whitespace-nowrap">{{ data.certificate_id.request_number }}</TableDataCell>
                        <TableDataCell :status="'record'" class="whitespace-nowrap">{{ data.certificate_id.cover_letter_id[0].request_number }}</TableDataCell>
                        <TableDataCell :status="'record'" class="whitespace-nowrap">{{ data.certificate_id.user_id[0].name }}</TableDataCell>
                        <TableDataCell :status="'record'" class="whitespace-nowrap">{{ data.certificate_id.created_at }}</TableDataCell>
                        ...
                        <div class="relative overflow-x-auto">
                            <table class="table-collapse w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            ALASAN MEMBUAT SURAT KETERANGAN
                                        </th>
                                        <td class="px-6 py-4">
                                            {{ form.description }}
                                        </td>
