<script setup>
    ...
    const modalLiatData = (data) => {
        ...
        form.couple_name = data.certificate_id.couple_name;
        form.partner_address = data.certificate_id.partner_address;
        form.guardian_name = data.certificate_id.guardian_name;
        form.wedding_date = data.certificate_id.wedding_date;
        form.name_of_the_chief = data.certificate_id.name_of_the_chief;
        form.bride_price = data.certificate_id.bride_price;
        form.witness_name = data.certificate_id.witness_name;
    ...
    const modalUbahData = (data) => {
        ...
        form.id = data.id;
        form.approvalCategory = data.approval_category;
    }
    const ubahData = () => {
            ...
            <Table>
                ...
                <template #default>
                    <TableRow v-for="(data, index) in fetchData.data" :key="data.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <TableDataCell :status="'record'">{{ data.approval_category }}</TableDataCell>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex justify-between my-3" v-for="history in form.history" :key="history.id">
                                                <div>
                                                    {{ history.step }}. {{ history.approver.name }}
                                                </div>
                                                <div>
