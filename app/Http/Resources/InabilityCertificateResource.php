...
class InabilityCertificateResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'history'         => InabilityCertificateHistory::where('certificate_id', $this->id)->with(['approver.employee', 'approver.employee.rank'])->get(),
        ];
    }
}
