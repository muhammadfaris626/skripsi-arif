...
class DomicileCertificateHistoryResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            'id' => $this->id,
            'certificate_id' => new DomicileCertificateResource(DomicileCertificate::find($this->certificate_id)),
