...
return new class extends Migration
{
    ...
    {
        Schema::create('unmarried_certificate_histories', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('certificate_id');
            $table->foreign('certificate_id')->references('id')->on('unmarried_certificates')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('unmarried_certificate_histories');
    }
};
